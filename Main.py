...
def subs(s1, s2, s3):
    ...
    file_subject_req = open("data_file")
...
def Main(ss1, ss2, ss3, district, zScr, bais=0.4):
    ...
    #     # print(k,len(k))
    #     z_pos[k] = z_pos[k].strip()
    #     print(z_pos)
        
    # print(sub_pos,file=open("pass","a+"))
    # print(z_pos,file=open("pass","a+"))
    for i in z_pos:
...
if __name__ == "__main__":
    ...
    # print(zScore(gg, z + bb))
    print(stru_json(Main(s1,s3,s2,gg,z,bb)))